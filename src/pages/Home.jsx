...
import { Play, Shield, Zap, Globe, ArrowUpRight } from 'lucide-react';
        ...
        <section className="py-32 relative">
            <div className="container mx-auto px-6 md:px-8">
                <div className="mb-20 text-center max-w-3xl mx-auto">
                    <h2 className="text-4xl md:text-6xl font-bold mb-6 text-white">The Ecosystem.</h2>
                    <p className="text-green-100/60 text-lg">Every detail refined. Every impact considered.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-6 h-auto md:h-[800px]">
                    ...
                    <motion.div
                        ...
                        className="col-span-1 md:col-span-2 row-span-2 rounded-[2.5rem] bg-[#0a2018]/60 border border-green-500/10 backdrop-blur-sm overflow-hidden relative group"
                    >
                        <img src="/case-forest.png" className="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:opacity-40 transition-opacity duration-700 scale-110 group-hover:scale-100" />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#051a14] via-transparent to-transparent" />
                        <div className="absolute bottom-0 left-0 p-10">
                            <h3 className="text-4xl font-bold mb-3 text-white">Zero Waste.</h3>
                            <p className="text-green-200/70 font-mono text-sm max-w-[200px] leading-relaxed">COMPLETE DECOMPOSITION IN 6 MONTHS UNDER COMPOST CONDITIONS.</p>
                        </div>
                        <ArrowUpRight className="absolute top-8 right-8 w-10 h-10 text-white opacity-0 group-hover:opacity-100 transition-opacity" />
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        whileHover={{ y: -5 }}
                        className="col-span-1 border border-green-500/10 rounded-[2.5rem] bg-[#0a2018]/40 backdrop-blur-sm p-8 flex flex-col justify-between relative overflow-hidden group hover:border-green-500/30 transition-colors"
                    >
                        <div className="absolute top-0 right-0 p-8 opacity-20 group-hover:opacity-100 transition-opacity">
                            <Shield className="w-16 h-16 text-green-500" />
                        </div>
                        <span className="font-mono text-xs text-green-400 uppercase tracking-widest">Resistance</span>
                        <div>
                            <div className="text-6xl font-bold text-white mb-2">10ft</div>
                            <p className="text-green-100/50 text-sm">MILITARY GRADE<br />DROP PROTECTION</p>
                        </div>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        whileHover={{ y: -5 }}
                        className="col-span-1 bg-green-500 rounded-[2.5rem] p-8 flex flex-col justify-between group overflow-hidden relative"
                    >
                        ...
                        <span className="font-mono text-xs text-[#051a14]/60 uppercase tracking-widest relative z-10">Connectivity</span>
                        <div className="relative z-10">
                            <Zap className="w-12 h-12 text-[#051a14] mb-4" />
                            <h3 className="text-2xl font-bold text-[#051a14] leading-none mb-2">MagSafe<br />Ready</h3>
                            <p className="text-[#051a14]/70 text-sm">SNAP ON. CHARGE UP.</p>
                        </div>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="col-span-1 md:col-span-2 bg-gradient-to-br from-green-900/40 to-[#051a14]/40 border border-green-500/20 rounded-[2.5rem] p-10 flex items-center justify-between overflow-hidden relative"
                    >
                        <div className="relative z-10">
                            <h3 className="text-3xl font-bold text-green-400 mb-2">Ocean Reborn</h3>
                        ...
                        <div className="text-right relative z-10">
                            <div className="text-5xl md:text-7xl font-mono font-bold text-white tracking-tighter">14,392</div>
                            <div className="text-xs font-mono text-green-500 uppercase tracking-widest mt-2">Lbs Plastic Removed</div>
                        </div>
